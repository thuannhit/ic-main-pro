...
import { FinancialStatementComponent } from './components/financial-statements/financial-statements.component'
...
@NgModule({
  ...
  declarations: [CashManagementComponent, TopupWithdrawComponent, FinancialStatementComponent],
  exports: [CashManagementComponent],
  bootstrap: [],
  providers: []
})
